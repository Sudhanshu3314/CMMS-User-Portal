                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <Input
                                        prefix={<UserOutlined className="text-purple-500 text-lg mr-2" />}
                                        ...
                                        },
                                        {
                                            validator: (_, value) =>
                                                value && value.endsWith("@igidr.ac.in")
                                                    ? Promise.resolve()
                                                    : Promise.reject(
                                                        new Error("IGIDR email address required ( @igidr.ac.in )")
                                                    ),
                                        },
                                    ]}
                                >
                            ...
                            <Form.Item className="mb-0">
                                ...
                                >
                                    ...
                                    <Link
                                        to="/login"
                                        className="text-purple-600 hover:text-purple-700 font-bold transition-colors duration-200 relative group/signin"
                                    >
                                        Sign in
                                        <motion.span
